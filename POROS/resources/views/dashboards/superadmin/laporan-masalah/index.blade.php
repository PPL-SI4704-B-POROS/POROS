...
<div class="dashboard-layout">
    ...
    <main class="main-content">
        ...
        @if(session('success'))
            <div class="alert alert-success" style="background: #d1fae5; border: 1px solid #6ee7b7; color: #065f46; padding: 0.75rem 1rem; border-radius: 0.5rem; margin-bottom: 1rem;">
                {{ session('success') }}
            </div>
        @endif
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #f1f5f9;" class="table-row-hover">
                        ...
                        <td style="padding: 1rem 1.25rem;">
                            ...
                            <div style="color: var(--text-muted); font-size: 0.8rem; margin-top: 0.2rem; max-width: 300px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">{{ $item->deskripsi }}</div>
                        </td>
                        <td style="padding: 1rem 1.25rem;">
                        ...
                        <td style="padding: 1rem 1.25rem;">
                            <div style="display: flex; gap: 0.5rem; align-items: center;">
                                {{-- Tombol lihat detail & foto bukti --}}
