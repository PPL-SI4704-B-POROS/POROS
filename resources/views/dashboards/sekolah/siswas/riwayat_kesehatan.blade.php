                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    ...
                                    if ($status === 'Kurus') $badgeClass = 'gizi-kurus';
                                    elseif ($status === 'Gemuk') $badgeClass = 'gizi-gemuk';
                                    elseif ($status === 'Obesitas') $badgeClass = 'gizi-obesitas';
                                @endphp
